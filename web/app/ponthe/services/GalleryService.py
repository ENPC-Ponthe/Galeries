...
class GalleryService:
    @staticmethod
    def delete(gallery_slug: str, current_user: User):
    ...
    @staticmethod
    def make_private(slug: str, current_user: User):
    ...
    @staticmethod
    def get_galleries_by_year(current_user: User):
        galleries_by_year = {
            year: {
                'public': GalleryDAO.find_public_by_year(year),
                'private': GalleryDAO.find_private_by_year(year, current_user),
    ...
    @staticmethod
    def approve(gallery_slug: str, current_user: User):
        gallery = GalleryDAO().find_by_slug(gallery_slug)
        if GalleryDAO.has_right_on(gallery, current_user):
            for file in gallery.files:
